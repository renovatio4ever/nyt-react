# New York Times React Application
...
[https://nanonewsonthemoon.herokuapp.com/](https://nanonewsonthemoon.herokuapp.com/)

## <a name="screenshots"></a> Screenshots

![NYT React Application Screenshot](/client/public/images/screenshots/nyt-scraper-react-app.jpg)
...
If you don't want to set up this project locally and just want to see the deployed application, go to <https://nanonewsonthemoon.herokuapp.com/>.
...
<pre>
  git clone https://github.com/renovatio4ever/nyt-react.git
  cd NYT-React-Search
</pre>
...
<p>If you find an issue while using the app or have a request, <a href="https://github.com/renovatio4ever/nyt-react/issues/" target="_blank">log the issue or request here</a>. These issues will be addressed in a future code update.</p>